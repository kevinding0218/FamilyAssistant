...
namespace FamilyAssistant.Extensions {
    public static class EFExtensions {
        ...
        /// <param name="sqlText">target sql text</param>
        ...
        /// <returns></returns>
        public static DbCommand LoadSQLText (this DbContext context, string sqlText, bool prependDefaultSchema = true) {
        ...
        /// <param name="command"></param>
        /// <returns></returns>
        public async static Task ExecuteSQLTextAsync (this DbCommand command, Action<SprocResults> handleResults, System.Data.CommandBehavior commandBehaviour = System.Data.CommandBehavior.Default, CancellationToken ct = default (CancellationToken)) {
            if (handleResults == null) {
                throw new ArgumentNullException (nameof (handleResults));
            }
